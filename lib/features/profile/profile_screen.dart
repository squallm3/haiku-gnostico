...
// ─── Pantalla Mis Datos ───────────────────────────────────────────────────────
class _MisDatosScreen extends ConsumerStatefulWidget {
  final String userId;
  final AppColors colors;
  const _MisDatosScreen({required this.userId, required this.colors});

  @override
  ConsumerState<_MisDatosScreen> createState() => _MisDatosScreenState();
}

class _MisDatosScreenState extends ConsumerState<_MisDatosScreen> {
